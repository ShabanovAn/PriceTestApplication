...
public class PriceService  {
    ...
    private List<Price> mergePrices(List<Price> priceList1, List<Price> priceList2) {
        ...
        if (isDatesOverlaps(beginPrice1, endPrice1, beginPrice2, endPrice2)) {
            if (price1.getValue().equals(price2.getValue())) {
    ...
    private List<Price> intersectPrices(Price price1, Price price2) {
        ...
        if (endPrice2.before(endPrice1)) {
            ...
            price3.setProduct_code(price1.getProduct_code());
            price3.setNumber(price1.getNumber());
            price3.setDepart(price1.getDepart());
            price3.setBegin(endPrice2);
            price3.setEnd(endPrice1);
            price3.setValue(price1.getValue());
