...
import com.example.pricetestapplication.Price;
import com.example.pricetestapplication.PriceService;
...
public class PriceServiceTest {
    ...
    public void testEmptyOldPricesParameter() {
        ...
        Price price = new Price(22L, "11122312", 1551, 46, getDateOf2013(Month.AUGUST, 26), getDateOf2013(Month.SEPTEMBER, 1), 224_00L);
        newPrices.add(price);
    ...
    public void testEmptyNewPricesParameter() {
        ...
        Price price = new Price(1L, "11122312", 1551, 46, getDateOf2013(Month.APRIL, 5), getDateOf2013(Month.JULY, 20), 1_254_00L);
        oldPrices.add(price);
    ...
    public void testCorrectParameters() {
        Price price1 = new Price(1L, "122856", 1, 1, getJanuary2013(1, false), getJanuary2013(31, true), 11_000L);
        Price price2 = new Price(3L, "122856", 2, 1, getJanuary2013(10, false), getJanuary2013(20, true), 99_000L);
        Price price3 = new Price(5L, "6654", 1, 2, getJanuary2013(1, false), getJanuary2013(31, false), 5_000L);
        List<Price> oldPrices = Arrays.asList(price1, price2, price3);

        Price price6 = new Price(2L, "6654", 1, 2, getJanuary2013(12, false), getJanuary2013(13, false), 4_000L);
        Price price5 = new Price(4L, "122856", 2, 1, getJanuary2013(15, false), getJanuary2013(25, true), 92_000L);
        Price price4 = new Price(6L, "122856", 1, 1, getJanuary2013(20, false), getDateOf2013(Month.FEBRUARY, 20), 11_000L);
